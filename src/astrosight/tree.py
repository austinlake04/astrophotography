"""Tree model to display select image files.

Notes
-----
Based on the Qt's Simple Tree Model Example (https://doc.qt.io/qtforpython-6/overviews/qtwidgets-itemviews-simpletreemodel-example.html)
"""
